...
export class CreateTables1734067306523 implements MigrationInterface {
    name = 'CreateTables1734067306523'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`nested_comment\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`nested_comment\` ADD \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`nested_comment\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`nested_comment\` DROP COLUMN \`createdAt\``);
